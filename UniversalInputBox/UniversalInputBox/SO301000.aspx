...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" runat="Server">
        ...
        <script>
            ...
            var wsName = 'https://3031ac8e-823d-4816-b095-01388ddf39eb.mock.pstmn.io/suggest';
            var delimiter = ' ';
            var responseDelimiter = '\n';
            
            var customerLookup = {
                "C000000005": "Wright Corner",
    ...
    <px:PXFormView runat="server" ID="searchRequestFilterForm" DataMember="SearchRequestFilter" Caption="Search">
        <Template>
            <px:PXTextEdit runat="server" ID="CstPXTextEdit4" DataField="SearchRequest" CommitChanges="True" Width="600px">
                <ClientEvents ValueChanged="onInit"></ClientEvents>
            </px:PXTextEdit>
        </Template>
    </px:PXFormView>
...
<asp:Content ID="cont3" ContentPlaceHolderID="phG" runat="Server">
    ...
    <px:PXTab ID="tab" runat="server" Height="540px" Style="z-index: 100;" Width="100%">
        <Items>
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Transactions">
                                ...
                                <Columns>
                                    ...
                                    <px:PXGridColumn DataField="BranchID" Width="81px" RenderEditorText="True" CommitChanges="True" />
                                    ...
                                    <px:PXGridColumn DataField="SiteID" Width="81px" CommitChanges="True" />
                                    ...
                                    <px:PXGridColumn DataField="DiscountID" TextAlign="Left" CommitChanges="True" RenderEditorText="True" Width="90px" />
                                    ...
                                    <px:PXGridColumn DataField="TaskID" Label="Task" Width="81px" CommitChanges ="True" />
                            ...
                            <px:PXGridLevel DataMember="ShipmentList">
                                <RowTemplate>
                                    ...
                                    <px:PXSelector SuppressLabel="True" Size="s" ID="edShipmentNbr3" runat="server"
                                        DataField="ShippingRefNoteID" AutoRefresh="True"
                                        AllowEdit="True" edit="1" />
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="ShipmentType" Width="110px" />
                                    <px:PXGridColumn DataField="ShipmentNbr" AllowUpdate="False" />
                                    <px:PXGridColumn DataField="ShippingRefNoteID" Width="130px" />
                                    <px:PXGridColumn DataField="SOShipment__StatusIsNull" Width="90px" />
			...
			<px:PXTabItem Text="Service Management" VisibleExp="DataControls[&quot;chkIsFSIntegrated&quot;].Value = 1" BindingContext="form">
				<Template>
            ...
            <Levels>
                <px:PXGridLevel DataKeyNames="OrderType,OrderNbr,LineNbr,SplitLineNbr" DataMember="splits">
                    ...
                    <Columns>
                        ...
                        <px:PXGridColumn DataField="LotSerialNbr" Width="108px" AutoCallBack="True" />
    ...
    <px:PXSmartPanel ID="PXSmartPanel1" runat="server" Caption="Process Order" ShowAfterLoad="true"
        ...
        <px:PXFormView ID="fromQuickProcess" runat="server" DataSourceID="ds" Style="z-index: 100" Width="600px" CaptionVisible="False" DataMember="QuickProcessParameters" AllowCollapse="False">
            ...
            <Template>
	            ...
	            <px:PXSelector ID="edPrinterName" runat="server" DataField="PrinterName" CommitChanges="True"/>
